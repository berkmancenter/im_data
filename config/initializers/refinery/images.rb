...
Refinery::Images.configure do |config|
  ...
  config.dragonfly_secret = "a316716e171cbfd5879cf75cef88b2bb3d33ae0f1714b20a"
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "c:/Users/rwestphal/Projects/berkmancenter/im_data/public/system/refinery/images"
